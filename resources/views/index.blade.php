...
<!-- Header -->
<header id="header">
  <div class="intro" style="background: url({{ asset('/storage') }}/{{ $about_info->about_image }}) center center no-repeat;">
    <div class="overlay">
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 intro-text">
            <h1>{{ $about_info->about_title }}</h1>
            <p>{{str_limit($about_info->about_details,100)}}</p>
  ...
  <div class="container">
    ...
    <div class="row">
      @foreach ($services as $service)
        <div class="col-md-4">
          <div class="service-media"> <img src="{{ asset('/storage') }}/{{ $service->service_image }}" alt="Photo Nai "> </div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/01-large.jpg') }}" title="Project Title" data-lightbox-gallery="gallery1">
              ...
              <img src="{{ asset('/frontpage/img/portfolio/01-small.jpg') }}" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/02-large.jpg') }}" title="Project Title" data-lightbox-gallery="gallery1">
              ...
              <img src="{{ asset('/frontpage/img/portfolio/02-small.jpg') }}" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/03-large.jpg') }}" title="Project Title" data-lightbox-gallery="gallery1">
              ...
              <img src="{{ asset('/frontpage/img/portfolio/03-small.jpg') }}" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/04-large.jpg') }}" title="Project Title" data-lightbox-gallery="gallery1">
              ...
              <img src="{{ asset('/frontpage/img/portfolio/04-small.jpg') }}" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/05-large.jpg') }}" title="Project Title" data-lightbox-gallery="gallery1">
              ...
              <img src="{{ asset('/frontpage/img/portfolio/05-small.jpg') }}" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/06-large.jpg') }}" title="Project Title" data-lightbox-gallery="gallery1">
              ...
              <img src="{{ asset('/frontpage/img/portfolio/06-small.jpg') }}" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/07-large.jpg') }}" title="Project Title" data-lightbox-gallery="gallery1">
              ...
              <img src="{{ asset('/frontpage/img/portfolio/07-small.jpg') }}" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/08-large.jpg') }}" title="Project Title" data-lightbox-gallery="gallery1">
              ...
              <img src="{{ asset('/frontpage/img/portfolio/08-small.jpg') }}" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/09-large.jpg') }}" title="Project Title" data-lightbox-gallery="gallery1">
              ...
              <img src="{{ asset('/frontpage/img/portfolio/09-small.jpg') }}" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="testimonial">
          <div class="testimonial-image"> <img src="{{ asset('/frontpage/img/testimonials/01.jpg') }}" alt=""> </div>
      ...
      <div class="col-md-4">
        <div class="testimonial">
          <div class="testimonial-image"> <img src="{{ asset('/frontpage/img/testimonials/02.jpg') }}" alt=""> </div>
          <div class="testimonial-content">
      ...
      <div class="col-md-4">
        <div class="testimonial">
          <div class="testimonial-image"> <img src="{{ asset('/frontpage/img/testimonials/03.jpg') }}" alt=""> </div>
          <div class="testimonial-content">
            <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam sedasd commodo nibh ante facilisis bibendum dolor feugiat at."</p>
            <div class="testimonial-meta"> - John Doe </div>
          </div>
      ...
      <div class="col-md-4">
        <div class="testimonial">
          <div class="testimonial-image"> <img src="{{ asset('/frontpage/img/testimonials/04.jpg') }}" alt=""> </div>
          <div class="testimonial-content">
            <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam sedasd commodo nibh ante facilisis bibendum dolor feugiat at."</p>
            <div class="testimonial-meta"> - Johnathan Doe </div>
          </div>
      ...
      <div class="col-md-4">
        <div class="testimonial">
          <div class="testimonial-image"> <img src="{{ asset('/frontpage/img/testimonials/05.jpg') }}" alt=""> </div>
          <div class="testimonial-content">
            <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam sedasd commodo nibh ante facilisis bibendum dolor feugiat at."</p>
            <div class="testimonial-meta"> - John Doe </div>
          </div>
      ...
      <div class="col-md-4">
        <div class="testimonial">
          <div class="testimonial-image"> <img src="{{ asset('/frontpage/img/testimonials/06.jpg') }}" alt=""> </div>
          <div class="testimonial-content">
            <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam sedasd commodo nibh ante facilisis."</p>
            <div class="testimonial-meta"> - Johnathan Doe </div>
          </div>
  ...
  <div class="container">
    <div class="col-md-8">
      <div class="row">
        ...
        @endif
        <form method="post" action="{{ url('/contact/form/submit') }}" >
          @csrf
          <div class="row">
            <div class="col-md-6">
